  ...
  return (
    <div>
                  ...
                  <li><h5>
                    ...
                    <Modal show={showModal} onHide={handleModalClose} style={{ height: "550px" }}>
                      <Modal.Header className='bg-dark text-light'>
                        ...
                        <button className='btn btn-danger float-end' onClick={handleModalClose}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
      ...
      <div className='overlay'>
        ...
        <a href="https://shanmukharanaprathapm.netlify.app/" target="_blank"><button className="but1"><small>Developer Info</small></button></a>
      </div>
